...
async def _lifespan(app: "FastAPI"):
    ...
    from agent_native.startup_service import start_service
...
app.include_router(_agent_native_routes.preview_router)
app.include_router(_agent_native_routes.model_router)
app.include_router(_agent_native_routes.first_builder_router)
