...
class WSTransport:
    ...
    def __init__(self, ws: Any, loop: asyncio.AbstractEventLoop, *, peer: str = "unknown",
                 auth_identity: dict | None = None, managed_chat=None) -> None:
        self._ws = ws
        self._loop = loop
        self._peer = peer
        ...
        self.managed_chat = managed_chat
        self._closed = False
...
async def handle_ws(ws: Any, *, auth_identity: dict | None = None, subprotocol: str | None = None, managed_chat=None) -> None:
    ...
    try:
        ...
        transport = WSTransport(ws, asyncio.get_running_loop(), peer=peer, auth_identity=auth_identity, managed_chat=managed_chat)
